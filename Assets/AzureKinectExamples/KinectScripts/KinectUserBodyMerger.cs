...
namespace com.rfilkov.kinect
{
    ...
    public class KinectUserBodyMerger
    {
        ...
        public List<KinectInterop.BodyData> MergeUserBodies(ref ulong lastBodyFrameTime, BoneOrientationConstraints boneConstraints)
        {
            ...
            {
                KinectInterop.BodyData mergedBody = GetMergedBody(mergeableBodySets[i], i, ref world2SensorMat, ref lostUsers);
        ...
        private KinectInterop.BodyData GetMergedBody(List<KinectInterop.BodyData> alCloseBodies, int bodyIndex, ref Matrix4x4 world2SensorMat, ref List<string> lostUsers)
        {
